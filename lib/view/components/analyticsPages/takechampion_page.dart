...
class TakeChampion extends StatefulWidget {
  const TakeChampion({super.key});

  @override
  State<TakeChampion> createState() => _TakeChampionState();
}

class _TakeChampionState extends State<TakeChampion> {
